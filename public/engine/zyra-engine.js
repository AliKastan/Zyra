  ...
  var ZyraEngine = {
    ...
    setupInput: function () {
      ...
      function onDown(e) {
        ...
        self.swipeDir = null;
        if (!self.audioCtx) self.initAudio();
    ...
    setupButtons: function () {
      ...
      function btn(id, fn) {
        ...
        if (el) el.addEventListener('click', function (e) { e.stopPropagation(); self.sfx('click'); fn.call(self); });
      }
    ...
    updateHUD: function () {
      ...
      if (lvl.timeLimit) {
        ...
        if (remaining < 10) this.timerEl.style.color = '#FF6B6B';
    ...
    // ═══════════════════════════════════════════════════════════════════
    // SOUND SYSTEM (Web Audio oscillator-based)
    // ═══════════════════════════════════════════════════════════════════
    initAudio: function () {
    ...
    sfx: function (type) {
      ...
      if (type === 'tap' || type === 'click') {
        ...
        osc.frequency.setValueAtTime(350, now + 0.15); osc.frequency.setValueAtTime(300, now + 0.3);
